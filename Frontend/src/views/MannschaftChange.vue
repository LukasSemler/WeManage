<template>
  <main class="mx-auto max-w-lg px-4 pt-10 pb-12 lg:pb-16">
    <form>
      <div class="space-y-6">
        <div>
          <h1 class="text-lg font-medium leading-6 text-gray-900">Mannschaft anpassen</h1>
          <p class="mt-1 text-sm text-gray-500">Hier kannst du deine Mannschaft anpassen.</p>
        </div>
        ...
        <div>
          <label for="tags" class="block text-sm font-medium text-gray-700">Zugangscode</label>
          <input
            type="text"
            name="tags"
            id="tags"
        ...
        <div class="flex justify-end">
          ...
          <button
            type="submit"
            class="ml-3 inline-flex justify-center rounded-md border border-transparent bg-indigo-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            Create this project
          </button>
        </div>
