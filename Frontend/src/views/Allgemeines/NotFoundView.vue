<template>
  ...
  >
    <div class="mx-auto max-w-max">
      <main class="sm:flex">
        <p class="text-4xl font-bold tracking-tight text-lime-500 sm:text-5xl">404</p>
        <div class="sm:ml-6">
          ...
          <div class="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
            ...
            <a
              ...
              class="inline-flex items-center rounded-md border border-transparent bg-lime-100 px-4 py-2 text-sm font-medium text-lime-600 hover:bg-lime-200 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2"
              >Contact support</a
            >
          </div>
        </div>
