<template>
  ...
  >
    <div class="min-w-0 flex-1">
      <h1 class="text-3xl font-bold text-gray-900 sm:truncate">Ankündigungen</h1>
    </div>
    <div class="mt-4 flex sm:mt-0 sm:ml-4">
      <button
        ...
        @click="open = true"
        type="button"
        class="inline-flex items-center rounded-md border border-transparent bg-weManageGray px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-weManageLightGray"
      >
        Ankündigungen
